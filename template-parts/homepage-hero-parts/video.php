        ...
        <div class="container">
            ...
            <div class="homepage-welcome-text">
                <div class="col-auto text-<?php echo get_theme_mod( 'asadpro_hero_text_align', 'center' ) ?>">
                    <h2>Video Option Coming Soon .......... !</h2>
                <h1 class="display-3">
...
<?php if ( get_theme_mod( 'asadPro_heroBG_image' ) == 'img_link' ): ?>
<section id="header-bg-image">
    <img src="<?php echo esc_url( get_theme_mod( 'asadPro_heroBG_image_url' ) ) ?>">
    <div class="header-bg-image-overlay"></div>
</section>
<?php else: ?>
<section id="header-bg-image">
    <img src="<?php echo esc_url( get_theme_mod( 'asadPro_heroBG_image_upload' ) ) ?>">
    <div class="header-bg-image-overlay"></div>
</section>
<?php endif?>